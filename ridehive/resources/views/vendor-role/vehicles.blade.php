...
<div class="bg-white p-6 rounded-lg shadow mb-8">
    ...
    <form action="#" method="POST" class="space-y-4" enctype="multipart/form-data">
        ...
        <div>
            <label for="vehicle_image" class="block text-gray-600">Vehicle Image</label>
            <input type="file" id="vehicle_image" name="vehicle_image" class="border rounded w-full py-2 px-4 focus:ring-[#e75480]" accept="image/*" required>
        </div>

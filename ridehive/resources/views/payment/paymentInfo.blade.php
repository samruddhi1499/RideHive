        ...
        <form action="{{ route('stripe') }}" method="post">
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <input type="text" id="pickup_location" name="pickup_location" class="mt-2 w-full p-4 border rounded-lg focus:ring-[#e75480]" value="Mumbai" readonly>
                </div>
                <div>
                    <label for="dropoff_location" class="block text-lg font-medium text-gray-700">Dropoff Location</label>
                    <input type="text" id="dropoff_location" name="dropoff_location" class="mt-2 w-full p-4 border rounded-lg focus:ring-[#e75480]"  value="Pune"  readonly>
                </div>
                <div>
                    <label for="product_name" class="block text-lg font-medium text-gray-700">Product name</label>
                    <input type="text" id="product_name" name="product_name" class="mt-2 w-full p-4 border rounded-lg focus:ring-[#e75480]"  value="bike"  readonly>
                </div>
                <div class="flex space-x-4">
                    <div class="w-1/2">
                        <label for="start_date" class="block text-lg font-medium text-gray-700">Start Date</label>
                        <input type="date" id="start_date" name="start_date" class="mt-2 w-full p-4 border rounded-lg focus:ring-[#e75480]" value='2024-11-29'  readonly>
                    </div>
                    <div class="w-1/2">
                        <label for="end_date" class="block text-lg font-medium text-gray-700">End Date</label>
                        <input type="date" id="end_date" name="end_date" class="mt-2 w-full p-4 border rounded-lg focus:ring-[#e75480]" value='2024-11-30'  readonly>
                    </div>
            ...
            <div class="mt-8 space-y-4">
                <div>
                    ...
                    <input type="text" id="price" name="price" class="mt-2 w-full p-4 border rounded-lg focus:ring-[#e75480]" value=200.00 readonly>
                </div>
                <div>
